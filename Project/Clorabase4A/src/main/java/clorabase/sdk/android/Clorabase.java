...
import clorabase.sdk.android.messaging.InAppMessaging;
...
public class Clorabase {
    ...
    public ClorastoreCollection getDatabase() {
        ...
        return new ClorastoreCollection(db);
    }
    ...
    public ClorabaseStorage getStorage() throws IllegalStateException {
        return new ClorabaseStorage(clorabase4j.getStorage());
    }

    /**
     * Initialize the In-App messaging service with the given context and shows message
     * @param context The context of the application.
     */
    public void initInAppMessaging(Context context) {
        var project = clorabase4j.getConfig().project;
        InAppMessaging.getInstance(context,project,true);
    }

    /**
     * Get the In-App messaging service with the given context. This do not show message
     * @param context The context of the application.
     * @return The instance of CloseableInAppMessaging.
     */
    public InAppMessaging getMessagingService(Context context) {
        var project = clorabase4j.getConfig().project;
        return InAppMessaging.getInstance(context,project,false);
    }
