...
public class StorageFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        boolean isStorage = (boolean) MainActivity.doc.get("isStorageConfigured",false);
        if (!isStorage) {
            ...
            try {
                ...
                ClorabaseStorage.upload(MainActivity.CURRENT_PROJECT, file, new ClorabaseStorageCallback() {
                    ...
                    public void onComplete() {
                        dialog.dismiss();
                        var user = MainActivity.doc.get("username",null);
                        var url = String.format("https://github.com/%s/Clorabase-databases/releases/download/",user) + MainActivity.CURRENT_PROJECT + "/" + finalFilename;
