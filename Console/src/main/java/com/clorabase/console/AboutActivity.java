...
public class AboutActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        page.addEmailLink("contact@itsrahil.me");
        page.addGitHubLink("https://github.com/ErrorxCode");
        page.addLinkedinLink("https://www.linkedin.com/in/devrahil/");
        page.addTwitterLink("https://instagram.com/x0_rahil");
        page.setVersionNameAsAppSubTitle("3.0");
    }
}
